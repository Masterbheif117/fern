  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundAttachment: "fixed", // This will keep the background fixed while scrolling
      }}
    >
      ...
      <div className="bg-white bg-opacity-15 backdrop-filter backdrop-blur-md border border-white border-opacity-30 rounded-3xl p-8 max-w-3xl w-full mx-auto relative z-10 overflow-y-auto max-h-[80vh]">
            ...
            <div className="mb-6">
              ...
              {workoutPlan.schedule &&
                Object.entries(workoutPlan.schedule).map(([day, details]) => (
                  <div
                    key={day}
                    className="mb-8 p-4 rounded-lg bg-white bg-opacity-20 border border-white border-opacity-30"
                  >
